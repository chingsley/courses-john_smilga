...
const Filters = () => {
  ...
  const filterByCategory = (e: React.MouseEvent<HTMLButtonElement>) => {
    updateFilters('category', (e.target as HTMLButtonElement).textContent!);
  };

  const filterByCompany = (e: React.ChangeEvent<HTMLSelectElement>) => {
