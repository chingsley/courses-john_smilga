...
import { loadStripe, StripeCardElementChangeEvent, StripeCardElement, StripeCardNumberElement } from '@stripe/stripe-js';
import {
  CardElement,
  useStripe,
  Elements,
...
const promiseToLoadStripe = loadStripe(process.env.REACT_APP_STRIPE_PUBLIC_KEY!);
...
const CheckoutForm = () => {
  ...
  type StripeCard = StripeCardElement | StripeCardNumberElement | {
    token: string;
  };
...
const StripeCheckout = () => {
  return (
    <Wrapper>
      <Elements stripe={promiseToLoadStripe}>
        <CheckoutForm />
      </Elements>
    </Wrapper>
  );
