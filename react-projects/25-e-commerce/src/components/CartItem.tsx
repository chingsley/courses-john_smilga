...
import { CartItemCountToggleDirection, ICartItem } from '../types/carts';
...
const CartItem: React.FC<ICartItemProps> = (props) => {
  ...
  const increaseQty = () => {
    toggleCount(id, CartItemCountToggleDirection.Inc);
  };

  const decreaseQty = () => {
    toggleCount(id, CartItemCountToggleDirection.Dec);
  };
